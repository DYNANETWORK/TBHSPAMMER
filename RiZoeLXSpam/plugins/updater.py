...
OFFICIAL_UPSTREAM_REPO = "https://github.com/SUKHPAL443/TBHSPAMMERS"
BOT_IS_UP_TO_DATE = "**𝐓𝐁𝐇 𝐒𝐏𝐀𝐌𝐁𝐎𝐓** is up-to-date sur."
NEW_BOT_UP_DATE_FOUND = (
    "new update found for {branch_name}\n"
    "changelog: \n\n{changelog}\n"
    "updating your 𝐓𝐁𝐇 𝐒𝐏𝐀𝐌𝐁𝐎𝐓 ..."
)
...
async def restart(e):
    if e.sender_id in SUDO_USERS:
        text = "__U𝗽𝗱𝗮𝘁𝗶𝗻𝗴..... 𝗬𝗼𝘂𝗿 𝐓𝐁𝐇 𝐒𝐏𝐀𝐌𝐁𝐎𝐓 𝗨𝘀𝗲𝗿𝗯𝗼𝘁𝘀__\n𝗧𝘆𝗽𝗲 .ping 𝗔𝗳𝘁𝗲𝗿 5𝗺𝗶𝗻𝘀 𝗧𝗼 𝗰𝗵𝗲𝗰𝗸 𝗜'𝗺 𝗼𝗻 !!"
...
async def deploy_start(Riz, message, refspec, remote):
    ...
    await message.edit(
        "Updated your TBH SPAMMERS successfully sur!!!\n© @MAMBA_NETWORK"
    )
